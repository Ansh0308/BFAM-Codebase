    ...
    <ScreenContainer>
      ...
      {!loading && !error && items.length > 0 && (
        <>
          ...
          {/* Plain View wrapper with an explicit height, not just a style
              prop on ScrollView itself — RN Web's horizontal ScrollView
              doesn't size its own height to content and was clipping card
              text below the image (see TurfCard's fixed horizontal-variant
              height for the matching card-side half of this fix). */}
